...
import { Phone, Calendar, LayoutDashboard } from 'lucide-react';
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full px-4">
                ...
                {user && user.role === 'Patient' && (
                  <Link
                    ...
                    className="w-full sm:w-auto flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-emerald-500 text-white rounded-full font-bold hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 hover:shadow-emerald-500/40 ring-2 ring-emerald-400 animate-pulse"
                  >
